...
function App() {
  ...
  const handleBackToLanding = () => {
    setShowLandingPage(true);
    // Reset all states when going back to landing page
    setTopic('');
    setData(null);
    setMcqs(null);
    setLoading(false);
        ...
        <div style={{
          ...
          <header style={{
            ...
            <p style={{ marginTop: '8px', fontSize: '16px', opacity: 0.9 }}>
             A Smart Learning Path Recommender, Where Learning Meets Intuition
            </p>

            {/* Show username if student, else show Login/Register button if not authenticated */}
